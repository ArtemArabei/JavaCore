...
public class House extends Building implements ILightning, ISecuritySystem {
    ...
    public House() throws NotValidTemperatureException,
            NotValidHumidityException {
        this((int) (Math.random() * 120), (int) (Math.random() * 120));
    }

    public House(int temperature, int humidity) throws
        ...
        if (temperature > 100 || temperature < 0) {
            throw new NotValidTemperatureException("Температура приняла " +
                    "недопустимое значение (допустимо от 0 до 100)");
        }
        if (humidity > 100 || humidity < 0) {
            throw new NotValidHumidityException("Влажность приняла " +
                    "недопустимое значение (допустимо от 0 до 100)");
        }
    }
